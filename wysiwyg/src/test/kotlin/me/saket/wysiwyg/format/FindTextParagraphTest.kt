...
class FindTextParagraphTest {
  ...
  private fun findUnderCursor(input: String): TextParagraph {
    val snapshot = decodeTextSelection(input)
    return TextParagraph.findUnderCursor(snapshot.text, snapshot.selection)
  }
}
